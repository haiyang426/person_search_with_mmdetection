...
class SeqNetRoIHead(BaseRoIHead):
    ...
    def _bbox_forward(self, stage: int, x: Tuple[Tensor],
        ...
        cls_score, bbox_pred, id_pred = bbox_head(bbox_feats)
    ...
    def predict_bbox(self,
        ...
        rois, cls_scores, bbox_preds, id_preds = self._refine_roi(
            x=x,
            rois=rois,
    ...
    def _refine_roi(self, x: Tuple[Tensor], rois: Tensor,
        ...
        for stage in range(self.num_stages):
            ...
            if bbox_results['id_pred'] is not None:
        ...
        return rois, cls_scores, bbox_preds, id_preds
