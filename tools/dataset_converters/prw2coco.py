...
def parse_args():
    ...
    parser.add_argument('-i', '--input', default='/data/zhy/person_search_with_mmdetection/data/PRW', type=str, help='The root path of PRW')
    parser.add_argument(
        '-o', '--output', type=str, default='/data/zhy/person_search_with_mmdetection/data/PRW/annotations_coco', help='path to save coco formatted label file')
